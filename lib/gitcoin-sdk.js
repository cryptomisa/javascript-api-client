(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("gitcoinSdk", [], factory);
	else if(typeof exports === 'object')
		exports["gitcoinSdk"] = factory();
	else
		root["gitcoinSdk"] = factory();
...
exports.api = exports.Api = undefined;
...
var baseUrl = 'https://gitcoin.co/api/v2/bounties';
...
var Api = function () {
  function Api() {
    ...
    this._bounties = {
      all: function all() {
        return _axios2.default.get(baseUrl, { params: options }).then(function (res) {
          return res.data;
        });
      }
    };
...
//# sourceMappingURL=gitcoin-sdk.js.map